...
public class CharacterCreationManager : MonoBehaviour
{
    ...
    private void OnClickCreateButton()
    {
        ...
        if (name == "")
        {
            textMessage.text = "Por favor ingrese un nombre.";
            EnableButtons();
            return;
        }
        ...
        while (waitingServer)
        {
            ...
            {
                case 0:
                    textMessage.text = "Nombre Invalido.";
                    waitingServer = false;
                    break;

                case 1:
                    textMessage.text = "El nombre es muy corto.";
                    waitingServer = false;
                    break;

                case 2:
                    textMessage.text = "El nombre ya existe.";
                    waitingServer = false;
                    break;

                case 3:
                    textMessage.text = "No se pueden crear personajes adicionales.";
                    waitingServer = false;
                    break;

                case 4:
                    textMessage.text = "Parámetros de creación no válidos.";
                    waitingServer = false;
                    break;

                case 100:
                    textMessage.text = "Éxito de la creación!";
                    waitingServer = false;
                    break;
            }
        }
    ...
    {
        textMessage.text = "Esperando de un servidor..."; // Clean any old messages.
