...
public class CharacterSelectionManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        textMessage.text = "Recuperando información del personaje.";
        ...
        {
            textMessage.text = "Haga clic en el botón crear para crear un nuevo personaje.";
    ...
    private void OnClickDeleteButton()
    {
        if (characterSelected)
        {
            ConfirmDialog.Instance.PlayerConfirm("Eliminar personaje " + MainManager.Instance.selectedCharacterData.GetName() + "?", 2);
        }
    }
    ...
    public void DeleteCharacter()
    {
        ...
        textMessage.text = "Eliminando personaje " + characterData.GetName() + "...";
