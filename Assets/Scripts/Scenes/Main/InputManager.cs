...
public class InputManager : MonoBehaviour
{
    ...
    // Keyboard Keys.
    [HideInInspector]
    public static readonly KeyCode[] KEY_BINDINGS = new KeyCode[38];
    ...
    private void Update()
    {
        ...
        SHORTCUT_1_DOWN = Input.GetKeyDown(KEY_BINDINGS[14]) || Input.GetKeyDown(KEY_BINDINGS[15]);
        SHORTCUT_2_DOWN = Input.GetKeyDown(KEY_BINDINGS[16]) || Input.GetKeyDown(KEY_BINDINGS[17]);
        SHORTCUT_3_DOWN = Input.GetKeyDown(KEY_BINDINGS[18]) || Input.GetKeyDown(KEY_BINDINGS[19]);
        SHORTCUT_4_DOWN = Input.GetKeyDown(KEY_BINDINGS[20]) || Input.GetKeyDown(KEY_BINDINGS[21]);
        SHORTCUT_5_DOWN = Input.GetKeyDown(KEY_BINDINGS[22]) || Input.GetKeyDown(KEY_BINDINGS[23]);
        SHORTCUT_6_DOWN = Input.GetKeyDown(KEY_BINDINGS[24]) || Input.GetKeyDown(KEY_BINDINGS[25]);
        SHORTCUT_7_DOWN = Input.GetKeyDown(KEY_BINDINGS[26]) || Input.GetKeyDown(KEY_BINDINGS[27]);
        SHORTCUT_8_DOWN = Input.GetKeyDown(KEY_BINDINGS[28]) || Input.GetKeyDown(KEY_BINDINGS[29]);
        SHORTCUT_9_DOWN = Input.GetKeyDown(KEY_BINDINGS[30]) || Input.GetKeyDown(KEY_BINDINGS[31]);
        SHORTCUT_10_DOWN = Input.GetKeyDown(KEY_BINDINGS[32]) || Input.GetKeyDown(KEY_BINDINGS[33]);
        SHORTCUT_11_DOWN = Input.GetKeyDown(KEY_BINDINGS[34]) || Input.GetKeyDown(KEY_BINDINGS[35]);
        SHORTCUT_12_DOWN = Input.GetKeyDown(KEY_BINDINGS[36]) || Input.GetKeyDown(KEY_BINDINGS[37]);
